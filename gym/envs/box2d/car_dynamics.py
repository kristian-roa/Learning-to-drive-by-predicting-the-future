...
SIZE = 0.02
ENGINE_POWER = 100000000 * SIZE * SIZE / 10  # less power as I don't want to work with a racecar
WHEEL_MOMENT_OF_INERTIA = 4000 * SIZE * SIZE
FRICTION_LIMIT = (
    1000000 * SIZE * SIZE * 3  # increasing friction to avoid being stuck in donuts
...
class Car:
    def __init__(self, world, init_angle, init_x, init_y, main_car=True):
        self.world = world
        ...
        self.hull.main_car_hull = main_car
        self.hull.crashed = False
        self.hull.road_contacts = 0
        self.wheels = []
        self.fuel_spent = 0.0
        WHEEL_POLY = [
            (-WHEEL_W, +WHEEL_R),
